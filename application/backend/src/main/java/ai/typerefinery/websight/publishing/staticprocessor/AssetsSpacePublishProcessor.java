...
public class AssetsSpacePublishProcessor extends AbstractPublishProcessor {
  @Reference
  ...
  public boolean canProcess(ResourceResolver resourceResolver, String resourcePath) {
    ...
    if (resource != null) {
        ...
        if (valueMap != null && valueMap.containsKey(JcrConstants.JCR_PRIMARYTYPE)) {
            ...
            return (resource != null && primaryType.equals("ws:Assets"));
        }
    }
    return false;
  }
  ...
  public String getId() {
    return "ai/typerefinery/websight/publishing/static/assetsspace";
  }
