...
@Component
public class PublishSpaceWebAction implements WebAction {
  private static final WebActionConfig CONFIG = WebActionConfig.Builder.newWebActionConfig("/apps/typerefinery/components/actions/spaces/publishspace.js")
    .forAllModules()
