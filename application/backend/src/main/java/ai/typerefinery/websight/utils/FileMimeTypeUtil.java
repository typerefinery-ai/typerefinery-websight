...
public class FileMimeTypeUtil {
    ...
    /**
     * simple way to get mime type from file extension by lookling it up in a mimeTypes map.
     * @param extension
     * @return
     */
    public static String getMimeTypeFromExtension(@NotNull String extension) {
    ...
    public static Map<String, String> mimeTypes = new HashMap<String, String>(){{
        ...
        put(".exe", "application/vnd.microsoft.portable-executable");
        put(".f4v", "video/mp4");
        ...
        put(".geojson", "application/geo+json");
        put(".gif", "image/gif");
        ...
        put(".hxx", "text/plain");
        put(".i", "text/plain");
        put(".ical", "text/calendar");
        put(".icalendar", "text/calendar");
        ...
        put(".isma", "application/octet-stream");
        put(".ismv", "application/octet-stream");
