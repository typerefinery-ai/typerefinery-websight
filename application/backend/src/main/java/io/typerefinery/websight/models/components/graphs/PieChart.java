...
@Model(adaptables = Resource.class, resourceType = { "typerefinery/components/graphs/piechart" }, defaultInjectionStrategy = OPTIONAL)
@Exporter(name = "jackson", extensions = "json", options = { @ExporterOption(name = "SerializationFeature.WRITE_DATES_AS_TIMESTAMPS", value = "true") })
public class PieChart extends BaseComponent {
    @SlingObject
