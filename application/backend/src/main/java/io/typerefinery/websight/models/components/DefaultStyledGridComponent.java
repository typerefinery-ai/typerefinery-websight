...
public class DefaultStyledGridComponent implements Styled, Grid {
  ...
  @Override
  public String getLgSpacing() {
    return grid.getLgSpacing();
  }
  
  @Override
  public String getMdSpacing() {
    return grid.getMdSpacing();
  }

  @Override
  public String getSmSpacing() {
    return grid.getSmSpacing();
  }
