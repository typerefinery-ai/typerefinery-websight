...
describe("Input Component - Hidden Label (Preview)", () => {
  beforeEach(() => {
    cy.login();
  });
  ...
  it("renders input with hidden label correctly", () => {
    cy.visit(
      "/content/typerefinery-showcase/pages/components/forms/input.html"
    );

    cy.get('input[name="input_hidden_label"]')
      .should("exist")
      .should("have.attr", "type", "text")
      .should(
        "have.attr",
        "placeholder",
        "Click on edit -> toggle hide Label to show/hide label"
      );
  });

  it("input with hidden label has correct component attribute", () => {
    cy.visit(
      "/content/typerefinery-showcase/pages/components/forms/input.html"
    );
  ...
  it("allows typing in input with hidden label", () => {
    cy.visit(
      "/content/typerefinery-showcase/pages/components/forms/input.html"
    );
